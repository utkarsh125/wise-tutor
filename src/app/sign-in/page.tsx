...
function createNoise() {
    ...
    // Pre-fill the array with 0's so that every index is defined.
    const p = new Array<number>(512).fill(0);
    for (let i = 0; i < 256; i++) {
...
const ParticlesBackground: React.FC<ParticlesBackgroundProps> = ({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      // Use a subtle fill based on the FBE4D6 background (rgb(251,228,214))
      ctx.fillStyle = "rgba(251,228,214, 0.1)"
      ...
      for (const particle of particles) {
        ...
        // Draw particles in a subtle dark tone
